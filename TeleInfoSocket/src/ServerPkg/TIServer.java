...
//				String sMsgReceived = "";
				...
				ReceiveServices.receiveMessage(socket, sConsoleHeader, input, output, outputStream, inputStream); //receive all msgs
...
//					System.out.println( Tools.determineHeaderBannerReceive(eMT)); //("Recevoir bienvenue");
